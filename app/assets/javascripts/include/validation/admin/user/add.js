  ...
  $("#frmAddUser").validate({
    ...
    messages: {
      ...
      "user[email]":{
        ...
        remote: I18n.t("javascript.validation.register.email.remote")
      },
      "user[password]": {
        required: I18n.t("javascript.validation.register.password.required"),
        minlength: I18n.t("javascript.validation.register.password.minlength")
      },
      "user[password_confirmation]": {
        required: I18n.t("javascript.validation.register.password_confirmation.required"),
        minlength: I18n.t("javascript.validation.register.password_confirmation.minlength"),
        equalTo: I18n.t("javascript.validation.register.password_confirmation.equalTo")
      },
      "user[address]": {
